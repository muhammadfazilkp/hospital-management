    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Text(
            'By accessing and using the Hospital Management System (referred to as "HMS," "System," or "Service"), you agree to comply with and be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use the Service.',
            style: payment,
          ),
          box,
          Text(
